  ...
  return (
    <>
      <label
        ...
        className="row-start-2 justify-self-center w-12 tablet:w-[86px] h-12 tablet:px-7 px-3 py-3 desktop:hidden block  rounded-[100px] bg-main-white cursor-pointer"
      >
        <input type="checkbox" id="menu_checkbox" className="hidden peer/modal" checked={isModalActive} />
