...
const Banners = () => {
  ...
  return (
    <div className="flex flex-col tablet:grid grid-cols-3 gap-6">
        <div className="p-6 grid grid-rows-[auto_auto_auto] desktop:grid-rows-2 desktop:grid-cols-2 text-center desktop:text-start rounded-md bg-base--gray-background">
            ...
            <img className="row-start-1 row-end-2 desktop:row-end-3 desktop:col-start-2 justify-self-center desktop:justify-self-end" src="/img/banners/community_banner.png" alt="community" />
        </div>
        ...
        <div className="p-6 grid grid-rows-[auto_auto_auto] desktop:grid-rows-2 desktop:grid-cols-2 text-center desktop:text-start rounded-md bg-base--gray-background">
            ...
            <img className="row-start-1 row-end-2 desktop:row-end-3 desktop:col-start-2 justify-self-center desktop:justify-self-end" src="/img/banners/support_banner.png" alt="support" />
        </div>
        ...
        <div className="p-6 grid grid-rows-[auto_auto_auto] desktop:grid-rows-2 desktop:grid-cols-2 text-center desktop:text-start rounded-md bg-base--gray-background">
            ...
            <img className="row-start-1 row-end-2 desktop:row-end-3 desktop:col-start-2 justify-self-center desktop:justify-self-end" src="/img/banners/peace_banner.png" alt="peace of mind" />
        </div>
    </div>
  )
}
